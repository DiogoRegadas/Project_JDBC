...
public class ProdutoGUI extends Application {
    ...
    public void start(Stage palco) {
        ...
        produtos = FXCollections.observableArrayList(produtoDAO.listarProdutos()); // Carrega todos os produtos do banco de dados
        ...
        addButton.setOnAction(e -> {
            ...
            produtoDAO.inserirProduto(produto); // Insere o novo produto no banco de dados
            produtos.setAll(produtoDAO.listarProdutos()); // Atualiza a lista de produtos na tela
        ...
        updateButton.setOnAction(e -> {
            ...
            if (selectedProduto != null) {
                ...
                produtoDAO.atualizarProduto(selectedProduto); // Atualiza o produto no banco de dados
                produtos.setAll(produtoDAO.listarProdutos()); // Atualiza a lista de produtos
        ...
        deleteButton.setOnAction(e -> {
            Produto selectedProduto = tableView.getSelectionModel().getSelectedItem(); // Obtém o produto selecionado
            if (selectedProduto != null) {
                produtoDAO.removerProdutoPorId(selectedProduto.getIdProduto()); // Exclui o produto do banco de dados
                produtos.setAll(produtoDAO.listarProdutos()); // Atualiza a lista de produtos
                limparCampos(); // Limpa os campos de entrada
            }
        });
